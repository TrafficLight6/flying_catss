...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/main_community.css">
    <link rel="icon" href="/awcxk-o1250-001.ico">
    <title>Flying Catss</title>
</head>
<body>
    <div class="header">
        <div class="top"><h1><i>Flying Catss!!!</i></h1><p>星星之火，可以燎原——毛泽东</p><form name="search" action="/search"><input type="text" name="kw" placeholder="搜索帖子"><input class="sub" type="submit" value="搜索"></form></div>
