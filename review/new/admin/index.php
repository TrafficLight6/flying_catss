...
<body>
    ...
    <div class="main">
        ...
        <div class="right">
            <form name="newa" onsubmit="return mycheck()" method="post" action="/">
            <p>标题（无需在正文中再写标题）<input type="text" name="noa_title"></p>
            <div id="editor—wrapper">
                <div id="toolbar-container"><!-- 工具栏 --></div>
                <div id="editor-container"><!-- 编辑器 --></div>
            </div>
            <textarea style="width:0px; height:0px; outline: none;" id="new_a_text" name="noa_main"></textarea><input type="submit" value="发一条友善的帖子"></form>


            <script>
                function mycheck(){
                    if (newa.noa_title.value==""){
                        alert("标题捏？");
                        return false;
                    }
                    if (newa.noa_main.value=="<p><br></p>"){
                        alert("内容捏？");
                        return false;
                    }
                    if (newa.noa_main.value==""){
                        alert("内容捏？");
                        return false;
                    }
                }
    ...
    const editorConfig = {
        ...
        onChange(editor) {
          ...
          document.getElementById('new_a_text').value = html
          // 也可以同步到 <textarea>
        }
    }
